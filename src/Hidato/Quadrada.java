    ...
    public ArrayList<Cela> Veins(String direccio) {
        ...
        if(Adjacencia.equals("C")){
            ...
            if(direccio.equals("H")){
                if(ran.nextInt(2) < 1){ ordre.add(1);ordre.add(3);}
                else{ ordre.add(3);ordre.add(1); }
                if(ran.nextInt(2) < 1){ ordre.add(0);ordre.add(2); }
            ...
            if(direccio.equals("H")){
                ...
                if(ran.nextInt(2) < 1){ ordre.add(0);ordre.add(4); }
                ...
                if(ran.nextInt(2) < 1){ ordre.add(2);ordre.add(6); }
